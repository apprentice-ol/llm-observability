...
让 `com.jjx.ai:llm-observability:0.1.1-SNAPSHOT` 变成可被其它项目拉取的“真依赖”，
...
- `com.jjx.ai:llm-observability:0.1.1-SNAPSHOT`
- `com.jjx.ai:llm-observability-backends:0.1.1-SNAPSHOT`
...
把版本改成 `0.1.1` 后再次 `mvn deploy`，就可以给外部用正式版本号：
